...
{
    /// <summary>
    /// Test Case 2 is a very simple case that use tcp server to receive bytes and interpret
    ...
    public class TestCase2
    {
        ...
        {
            OctopusConfig oc = OctopusConfig.Load("TcpServer\\TestCase2\\TestCase2.xml");
